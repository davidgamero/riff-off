<script lang="ts">
	...
	import { faPauseCircle, faPlayCircle, faCog } from '@fortawesome/free-solid-svg-icons';
	...
	onMount(() => {
		goal = Number($page.url.searchParams.get('goal'));
...
<div class="h-full flex flex-col justify-between align-middle p-6">
	...
	<div class="flex justify-between items-center m-4">
		...
		<button on:click={showSettingsModal}>
			<Fa icon={faCog} size="3x" class="text-gray-500 hover:text-gray-600" />
		</button>
	</div>
	<PlayButton
		score={teamBlueScore}
